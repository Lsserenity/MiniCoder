...
项目简介
MiniCoder 是一个基于 Python 3.11 的轻量级本地 Coding Agent。它通过 CLI 与用户交互，通过 OpenAI 兼容接口调用 GLM-4.7-Flash，并使用本地工具完成代码理解、文件修改、命令执行、任务规划和基础安全控制。
...
3. 任务规划：通过 update_plan 维护 pending、in_progress、completed 状态，并可使用 /plan 查看。
